resource "azurerm_monitor_data_collection_rule" "dcr-log-analytics" {
  ...
  kind                        = "Linux"
  depends_on                  = [time_sleep.wait_60_seconds,azurerm_resource_group.example]
...
resource "azurerm_monitor_data_collection_rule_association" "dcra-dcr-log-analytics-aks" {
    depends_on = [ azurerm_resource_group.example,azurerm_kubernetes_cluster.aks_cluster, azurerm_monitor_data_collection_rule.dcr-log-analytics ]
